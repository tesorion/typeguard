...
module Yard
  module Test
    ...
    class Basic
      ...
      # @param klass_instance [Yard::Test::NestedOnce::NestedClassOne] nested class one
      # @return [(Yard::Test::NestedOnce::NestedClassOne, Yard::Test::NestedOnce::NestedTwice::NestedClassTwo)] array of nested classes
